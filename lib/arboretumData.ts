...
function createArboretum(data: Omit<Arboretum, "zones" | "routes" | "spots"> & {
  ...
  return {
    ...
    mapReferenceUrl: data.mapReferenceUrl,
    mapReferenceLabel: data.mapReferenceLabel,
...
export const arboretums: Arboretum[] = [
  createArboretum({
    ...
    mapReferenceUrl: "https://kna.forest.go.kr/",
    mapReferenceLabel: "국립수목원 관람 안내",
    locationNote: "광릉숲 보전 지역에 위치해 사전 예약과 지정 동선 확인이 중요합니다.",
  ...
  createArboretum({
    ...
    mapReferenceUrl: "https://www.bdna.or.kr/",
    mapReferenceLabel: "국립백두대간수목원 관람 안내",
    locationNote: "넓은 부지와 장거리 동선이 특징이라 방문 전 권역별 이동 시간을 확인하는 것이 좋습니다.",
  ...
  createArboretum({
    ...
    mapReferenceUrl: "https://www.sjna.or.kr/",
    mapReferenceLabel: "국립세종수목원 관람 안내",
    locationNote: "도심 접근성이 좋은 수목원으로 실내 온실과 야외 정원을 함께 계획하기 좋습니다.",
  ...
  createArboretum({
    ...
    mapReferenceUrl: "https://www.morningcalm.co.kr/",
    mapReferenceLabel: "아침고요수목원 관람 안내",
    locationNote: "가평 관광지와 연계하기 좋아 계절 축제 기간에는 입장 시간과 혼잡도를 함께 확인하세요.",
  ...
  createArboretum({
    ...
    mapReferenceUrl: "https://www.hantaek.co.kr/",
    mapReferenceLabel: "한택식물원 관람 안내",
    locationNote: "식물 수집·보전형 식물원이라 테마 정원별 식물 차이를 비교하며 보기 좋습니다.",
  ...
  createArboretum({
    ...
    mapReferenceUrl: "https://sumokwon.jeju.go.kr/",
    mapReferenceLabel: "한라수목원 관람 안내",
    locationNote: "제주시 도심에서 가까워 짧은 일정에도 제주 자생식물 관람을 넣기 좋습니다.",
  ...
  createArboretum({
    ...
    mapReferenceUrl: "https://botanicpark.seoul.go.kr/",
    mapReferenceLabel: "서울식물원 관람 안내",
    locationNote: "열린숲·호수원·습지원·주제원 권역이 나뉘어 있어 실내외 동선을 나누어 보기 좋습니다.",
  ...
  createArboretum({
    ...
    sourceLabel: "제이드가든 공개 자료",
    sourceUrl: "https://en.wikipedia.org/wiki/Jade_Garden",
    mapReferenceUrl: "https://en.wikipedia.org/wiki/Jade_Garden",
    mapReferenceLabel: "제이드가든 위치·개요 자료",
    locationNote: "춘천 남산면 숲속에 자리해 정원 산책과 사진 촬영 목적의 방문에 잘 맞습니다.",
  ...
  createArboretum({
    ...
    mapReferenceUrl: "https://wando-arboretum.jeonnam.go.kr/",
    mapReferenceLabel: "완도수목원 관람 안내",
    locationNote: "난대림 숲길 비중이 높아 걷기 편한 신발과 충분한 관람 시간을 준비하면 좋습니다.",
  ...
  createArboretum({
    ...
    mapReferenceUrl: "https://www.daegu.go.kr/",
    mapReferenceLabel: "대구수목원 안내",
    locationNote: "도심형 수목원이라 짧은 산책, 가족 방문, 계절 화단 관람에 편리합니다.",
  ...
  createArboretum({
    ...
    mapReferenceUrl: "https://farm.gg.go.kr/sigt/85",
    mapReferenceLabel: "물향기수목원 안내",
    locationNote: "물과 습지 주제의 구역이 많아 아이와 함께 생태 관찰 코스로 구성하기 좋습니다.",
  ...
  createArboretum({
    ...
    mapReferenceUrl: "https://www.yeoju.go.kr/",
    mapReferenceLabel: "황학산수목원 안내",
    locationNote: "여주 시내와 가까운 숲길형 수목원으로 가벼운 산책 코스에 적합합니다.",
  ...
  createArboretum({
    ...
    mapReferenceUrl: "https://www.chollipo.org/",
    mapReferenceLabel: "천리포수목원 밀러가든 안내",
    locationNote: "천리포 해변과 가까운 바다숲형 수목원으로 주제원과 해안 경관을 함께 보기 좋습니다.",
